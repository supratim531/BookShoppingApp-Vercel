    ...
    <div className="mt-2 py-6 flex justify-center bg-[#212124]">
      <div className="flex flex-col items-center space-y-10">
        <div className="w-[400px] flex items-center gap-2 font-medium">
          ...
          <div className="text-rose-500"><span className="font-normal text-slate-400">Made by </span><span className="text-[#4cfc29]"><a href="https://wa.me/+917596859011">Supratim Majumder</a></span></div>
        </div>
